...
const legalEnhancements: Record<Locale, LegalEnhancements> = {
  ...
  ja: {
    companyIdentity:
      "ベルン州商業登記簿に登録されたスイス法上の株式会社\n商業登記番号: CH-550.0.125.280-2\n企業識別番号 (UID): CHE-100.171.369",
    legal: {
      registry: {
        title: "会社情報と連絡先",
        paragraphs: [
          "Domteknika S.A. は、La Neuveville に本店を置くスイス法上の株式会社です。このページに記載する会社情報は、最終更新日時点で公開されている商業登記情報に基づきます。",
          "このウェブサイトに関する一般的なお問い合わせ、通知、およびそのコンテンツに関するリクエストは、上記の住所、電話番号、または電子メール アドレス宛にお送りいただくことができます。",
        ],
      },
      scope: {
        title: "ウェブサイトの目的と範囲",
        paragraphs: [
          "このウェブサイトでは、DOMTEKNIKA、そのエンジニアリング能力、厳選されたプロジェクト、および公開されている特許情報を紹介します。そのコンテンツは、一般的な企業および情報提供のみを目的として提供されています。 DOMTEKNIKA が署名した別の書面に明示的に記載されていない限り、これはオファー、技術仕様、専門的アドバイス、保証、または契約上の約束を構成するものではありません。",
          "ウェブサイトへのアクセスと使用には、この法的通知および強行法が適用されます。 DOMTEKNIKA は、メンテナンス、セキュリティ、ビジネス上の理由など、合理的に必要な場合には、ウェブサイトの全部または一部を変更、一時停止、または撤回することがあります。",
        ],
      },
      submissions: {
        title: "機密情報と事前合意のない提出",
        paragraphs: [
          "公開ウェブサイトとお問い合わせフォームは、機密資料を共有するための専用環境ではありません。フォームの利用だけで、機密保持、受託、助言または契約上の関係が成立することもありません。DOMTEKNIKA が適切な方法で受け取ることに事前に明示的に同意していない限り、営業秘密、特許出願につながり得るアイデア、規制対象のデータ、機微な個人情報、第三者に属する情報を公開フォームから送信しないでください。",
          "プロジェクトの機密保持、成果の権利帰属、ライセンス、納品物とその利用範囲は、該当する書面の提案書、秘密保持契約またはプロジェクト契約で定めます。事前合意のないアイデアを受け取り、または受領を確認しても、その採用、独占権、報酬、評価・利用の義務が生じるものではありません。",
        ],
      },
      acceptableUse: {
        title: "許可される利用と禁止事項",
        paragraphs: [
          "あなたはウェブサイトを閲覧し、その公開情報を正当な個人的または職業的評価のために使用することができます。その運用やセキュリティを妨害したり、不正アクセスを試みたり、悪意のあるコードを導入したり、技術的手段を回避したり、他人になりすましたり、適用法や第三者の権利を侵害する方法で Web サイトを使用したりしてはなりません。",
          "コンテンツの大量取得、スクレイピング、フレーム内表示、再公開、競合するデータベースの作成、保護された操作機能のリバースエンジニアリング、商用 AI モデルの学習・改良を目的とするコンテンツ利用には、法令で制限が禁じられる場合を除き、DOMTEKNIKA の事前の書面による許可が必要です。",
        ],
      },
      privacy: {
        title: "個人データ",
        paragraphs: [
          "このウェブサイトに関連した個人データの処理については、プライバシー ポリシーに記載されています。このポリシーは、Web サイトの使用を管理する情報の一部を構成しますが、強制的なデータ保護法によって付与される権利を制限するものではありません。",
        ],
      },
      changes: {
        title: "ウェブサイトおよびこのお知らせの変更",
        paragraphs: [
          "DOMTEKNIKA は、サービス、技術、または法的義務の変更を反映するために、ウェブサイトおよびこの法的通知を更新することがあります。オンラインで表示されるバージョンと更新日が現在のバージョンです。すでに書面で合意されている重要な契約上の権利は、ウェブサイトの更新によって変更されることはありません。",
        ],
      },
      severability: {
        title: "可分性と強行法",
        paragraphs: [
          "この通知の条項が無効または法的強制力がない場合でも、残りの条項は法律で認められる範囲で影響を受けません。適用されるスイスの法律に基づく故意の違法行為または重大な過失に対する責任を含め、除外または制限が禁止されている場合には、責任を除外または制限する規定はありません。",
        ],
      },
    },
    privacy: {
      scope: {
        title: "データの範囲とカテゴリ",
        paragraphs: [
          "このポリシーは、公開 Web サイト、お問い合わせフォーム、および関連するビジネス通信を通じて処理される個人データを対象としています。当社とのやり取りの方法に応じて、これには、識別情報と連絡先の詳細、会社情報と職業情報、リクエストの内容、通信履歴、言語設定、技術的な接続またはセキュリティ データが含まれる場合があります。",
          "通常、当社はお客様から直接データを収集するか、お客様がウェブサイトを使用するときにブラウザーから自動的にデータを収集します。また、当社は、お客様の雇用主、同僚、公的に入手可能な専門情報源、またはお客様を当社に紹介した人物から通常の業務連絡先の詳細を受け取る場合があります。",
        ],
      },
      legalBasis: {
        title: "個人情報を取り扱う法的根拠",
        paragraphs: [
          "スイス法に基づき、当社は本ポリシーに記載した目的のため、適法かつ必要な範囲で個人情報を取り扱います。GDPR が適用される場合、その法的根拠は、契約締結前にご本人の求めに応じて行う措置、契約の履行、法的義務の遵守、安全なサイト運営や取引関係の管理に関する当社の正当な利益、または必要に応じて求める同意です。",
          "同意は将来の取扱いについていつでも撤回できます。撤回前に行った取扱いや、別の法的根拠に基づく取扱いには影響しません。",
        ],
      },
      emailProvider: {
        title: "お問い合わせフォームの送信事業者",
        paragraphs: [
          "お問い合わせフォームから送信されたメッセージは、米国の Plus Five Five, Inc. が運営する Resend を通じて DOMTEKNIKA に届きます。送信される情報には、入力された連絡先とメッセージのほか、メールの送信と安全確保に必要なメタデータが含まれます。",
          "Resend は、アカウント情報、メールのメタデータ、ログ、API 記録を米国で保存すると説明しています。法令上必要な場合、国外へのデータ移転には標準契約条項など、認められた契約上の保護措置を適用します。機密のプロジェクト資料や機微なデータは、公開フォームから送信しないでください。",
        ],
        links: [
          { label: "Resend のプライバシーポリシー", href: "https://resend.com/legal/privacy-policy" },
          { label: "Resend のデータ処理契約", href: "https://resend.com/legal/dpa" },
        ],
      },
      automatedDecisions: {
        title: "自動化された意思決定とプロファイリング",
        paragraphs: [
          "DOMTEKNIKA は、この Web サイトを通じて収集されたデータを、法的または同様に重大な影響を与える自動化された個別の決定を行うために使用することはありません。ウェブサイトへの訪問から広告プロフィールを作成したり、個人データを販売したりすることはありません。",
        ],
      },
      children: {
        title: "未成年者について",
        paragraphs: [
          "この企業ウェブサイトは専門家および一般の読者を対象としており、子供を対象としたものではありません。当社は、お問い合わせフォームを通じて故意にお子様の個人データを要求することはありません。お子様が個人データを提出したと思われる親または保護者は、当社に連絡して審査および必要に応じて削除を要求することができます。",
        ],
      },
    },
  },
...
const legalPages: Record<Locale, LegalPages> = {
  ...
  ja: {
    legalNotice: {
      intro:
        "このページでは、DOMTEKNIKA ウェブサイトの運営会社と、サイトの利用条件についてご案内します。",
      updatedLabel: "最終更新日",
      updated: "2026年7月",
      sections: [
        {
          ...
          paragraphs: [
            "DOMTEKNIKA SA\nChemin de Saint-Joux 16B\n2520 La Neuveville\nスイス",
            "DOMTEKNIKA SA は、このウェブサイトの編集内容に責任を負います。",
          ],
          links: companyContact,
        },
        {
          title: "ホスティング",
          paragraphs: [
            "このウェブサイトは、スイスの Infomaniak Network SA（Rue Eugène Marziano 25, 1227 Les Acacias (GE), Switzerland）がホストしています。",
          ],
          links: [
            {
              label: "Infomaniak の法的情報",
              href: "https://www.infomaniak.com/en/legal/legal-notice",
            },
          ],
        },
        {
          title: "知的財産",
          paragraphs: [
            "特に明記されていない限り、このウェブサイト上の構造、テキスト、写真、イラスト、図面、ロゴ、ビデオおよびその他のコンテンツは、DOMTEKNIKA SA が所有するか、それぞれの権利所有者の許可を得て使用されています。これらはスイスおよび国際的な知的財産法によって保護されています。",
            "全部または一部の複製、翻案、頒布、商業利用には、DOMTEKNIKA SA からの事前の書面による許可が必要です。著作権および所有権の通知が保持されている限り、厳密に私的かつ非商業的な使用を目的としたコンテンツのダウンロードまたは印刷は引き続き許可されます。",
          ],
        },
        {
          title: "責任と外部リンク",
          paragraphs: [
            "DOMTEKNIKA SA は、このウェブサイト上の情報を正確かつ最新に保つために合理的な注意を払っています。ただし、コンテンツが完全であること、継続的に利用できること、エラーがないことを保証するものではありません。ウェブサイトの使用とそのコンテンツへの依存は、強行法に従って、訪問者の責任となります。",
            "外部サイトへのリンクは利用者の便宜のために掲載しています。DOMTEKNIKA SA は、それらの内容、利用可能性、個人情報の取扱いを管理しておらず、責任を負いません。",
          ],
        },
        {
          title: "準拠法",
          paragraphs: [
            "このウェブサイトとこの法的通知はスイスの法律に準拠します。強制管轄地に従う限り、DOMTEKNIKA SA の登記上の事務所にある裁判所が管轄権を持ちます。",
          ],
        },
      ],
    },
      privacyPolicy: {
      intro:
        "このポリシーは、ウェブサイトの利用やお問い合わせに際して、DOMTEKNIKA SA が個人情報をどのように取り扱うかを説明するものです。スイス連邦データ保護法（FADP）と、適用される場合には欧州一般データ保護規則（GDPR）に基づきます。",
      updatedLabel: "最終更新日",
      updated: "2026年7月",
      sections: [
        {
          ...
          paragraphs: [
            "DOMTEKNIKA SA\nChemin de Saint-Joux 16B\n2520 La Neuveville\nスイス",
            "個人情報の保護に関するご質問や、ご自身の情報についてのご請求は、以下の連絡先へお送りください。",
          ],
          links: companyContact,
        },
        {
          title: "ウェブサイトにアクセスしたときに処理されるデータ",
          paragraphs: [
            "Web サイトにアクセスすると、ホスティング プロバイダーは、サービスの提供と保護に必要な技術情報を自動的に記録する場合があります。これには、IP アドレス、アクセス日時、要求されたページまたはファイル、参照元、ブラウザ、オペレーティング システム、応答ステータスが含まれる場合があります。",
            "これらのサーバーログは、ウェブサイトの運用、障害の検出、悪用の防止、セキュリティの維持に使用されます。これらは、DOMTEKNIKA SA が広告プロファイルを作成するために使用するものではありません。",
          ],
        },
        {
          title: "お問い合わせ時の情報",
          paragraphs: [
            "メール、電話、またはお問い合わせフォームでご連絡いただいた場合、氏名、会社名、メールアドレス、電話番号、メッセージなど、ご提供いただいた情報を取り扱います。お問い合わせへの回答、今後の取引に向けた準備、必要な連絡記録の保存に使用します。",
            "事前に当社と合意していない限り、機密の技術情報や機密の個人データをフォームを通じて送信しないでください。",
          ],
        },
        {
          title: "処理の目的",
          items: [
            "ウェブサイトの提供、保守、保護。",
            "問い合わせへの対応、およびビジネス関係の準備または管理。",
            "法的義務を果たし、法的請求を主張または防御する。",
            "デジタルサービスの信頼性と使いやすさを向上させます。",
          ],
        },
        {
          title: "Cookie とアクセス解析",
          paragraphs: [
            "現在、Web サイトでは、選択された言語を保持できるように、機能言語優先 Cookie (NEXT_LOCALE) のみが使用されています。 DOMTEKNIKA SA は現在、この Web サイトで広告 Cookie、行動追跡、視聴者測定サービスを使用していません。",
            "オプションの分析またはマーケティング テクノロジーが後で導入される場合、このポリシーと必要に応じて同意メカニズムは、それらが有効になる前に更新されます。",
          ],
        },
        {
          title: "地図と外部コンテンツ",
          paragraphs: [
            "インタラクティブマップは、CARTO および OpenStreetMap を通じて提供される地図データとタイルを使用します。地図が表示されると、IP アドレスやブラウザのリクエストなどの技術データがこれらのプロバイダーに送信される場合があります。独自のプライバシー ポリシーが処理に適用されます。",
          ],
          links: [
            { label: "CARTO のプライバシーポリシー", href: "https://carto.com/privacy" },
            {
              label: "OpenStreetMap のプライバシーポリシー",
              href: "https://osmfoundation.org/wiki/Privacy_Policy",
            },
          ],
        },
        {
          title: "提供先と国外への移転",
          paragraphs: [
            "個人データは、権限のある従業員、およびホスティング、IT 運用、地図作成、専門的アドバイスをサポートするサービスプロバイダーに、業務に必要な範囲で開示される場合があります。当社は個人データを販売しません。",
            "一部のプロバイダーはスイス国外でデータを処理する場合があります。目的地が適切なレベルの保護を提供しない場合、当社は認められた保護手段、特に契約上の保護手段、または法定の例外に依存します。",
          ],
        },
        {
          title: "保存期間",
          paragraphs: [
            "当社は、上記の目的に必要な期間、ビジネス関係の継続中、および法的保持義務、証拠要件、または正当な利益が適用されるその後にのみ個人データを保持します。技術ログは、ホスティング プロバイダーの運用設定およびセキュリティ設定に従って保存されます。",
          ],
        },
        {
          title: "お客様の権利",
          paragraphs: [
            "適用されるデータ保護法に基づき、ご自身の個人情報について開示を求めることができます。法定の条件を満たす場合には、訂正、データの提供、削除、取扱いの制限を求め、特定の取扱いに異議を申し立てることもできます。また、管轄のデータ保護当局、スイスでは連邦データ保護・情報コミッショナー（FDPIC）に苦情を申し立てることができます。",
            "リクエストには身元証明が必要になる場合があります。法的な制限と例外は留保されたままです。",
          ],
          links: [
            {
              label: "連邦データ保護および情報コミッショナー",
              href: "https://www.edoeb.admin.ch/en",
            },
          ],
        },
        {
          title: "セキュリティとポリシーの更新",
          paragraphs: [
            "DOMTEKNIKA SA は、個人データを不正アクセス、紛失、誤用、または改ざんから保護するために、適切な組織的および技術的措置を講じます。ただし、完全に安全であることを保証できる送信方法や保存方法はありません。",
            "当社のサービスまたは法的要件が変更された場合、当社はこのポリシーを更新することがあります。このページで公開されている現在のバージョンが適用されます。",
          ],
        },
      ],
    },
...
export function getLegalPages(locale: string): LegalPages {
  ...
  const privacySections = pages.privacyPolicy.sections.map(section =>
    /Cookie|쿠키|クッキー/.test(section.title)
